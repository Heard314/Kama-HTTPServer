...
{
    // 加载证书
    std::cout<<"The certificateFile is "<<config_.getCertificateFile().c_str()<<".\n";
    ...
    // 加载私钥
    std::cout<<"The privateKeyFile is "<<config_.getPrivateKeyFile().c_str()<<".\n";
    ...
    // 加载证书链
    std::cout<<"The certificateChainFile is "<<config_.getCertificateChainFile().c_str()<<".\n";
    ...
    std::cout<<"All certificates have been loaded.\n";
    return true;
}
